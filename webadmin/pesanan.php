...
$query_transaksi = "SELECT pemesanan.*, mst_anggota.nama_bank, mst_anggota.rekening, mst_anggota.atas_nama, mst_anggota.jumlah_transfer, mst_anggota.no_order, mst_anggota.tanggal_transfer FROM pemesanan,mst_anggota WHERE pemesanan.ORDER_NO_ANGGOTA = mst_anggota.no_anggota ORDER BY pemesanan.ORDER_TGL DESC";
...
<table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" style="border:double; border-color:#009900;">
  ...
  <tr>
	...
	<td align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><a target="_blank" href="<?php echo '../images/'.$row_transaksi['bukti_transfer']?>"><img src="<?php echo '../images/'.$row_transaksi['bukti_transfer']?>" width="30" height="30"/></a>
	<a target="_blank" href="index.php?mod=lihat_rekening&no_anggota=<?php echo $row_transaksi['ORDER_NO_ANGGOTA']?>">
	<?php if(empty($row_transaksi['bukti_transfer'])){ 
		echo "nama bank : " . $row_transaksi['nama_bank']."<br>";
		echo "rekening : " . $row_transaksi['rekening']."<br>";
